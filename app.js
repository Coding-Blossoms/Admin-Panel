...
function profit2022() {
  let thisYear = document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(1)").className = ""

 let year2021 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(3)").className = "");

 let year2020 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(4)").className = "");

 let year2022 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(2)").className = "selcted-category-header-sec-baiane-ha");
...
function profit2021() {
  ...
  let year2022 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(2)").className = "");
  
  let year2020 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(4)").className = "");
  
  let year2021 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(3)").className = "selcted-category-header-sec-baiane-ha");
...
function profit2020() {
  ...
  let year2020 = (document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(4)").className = "selcted-category-header-sec-baiane-ha");
...
function profitThisYear() {
  ...
  let thisYear = document.querySelector("#header-sec-baiane-ha> div > li:nth-of-type(1)").className = "selcted-category-header-sec-baiane-ha"
